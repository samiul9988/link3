    ...
    <div class="carousel-inner">
        @forelse($sliders as $slider)
            <div class="carousel-item {{ $loop->first ? 'active' : '' }}">
                <div class="hero-slide" style="background-image: url('{{ asset($slider->image_desktop) }}');">
                    <div class="container">
                        <div class="content">
                            @if($slider->subtitle)
        ...
        @empty
            <div class="carousel-item active">
                <div class="hero-slide d-flex align-items-center justify-content-center" style="background: linear-gradient(135deg, #0D9488 0%, #0F766E 100%);">
